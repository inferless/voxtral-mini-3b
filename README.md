# Template - Deploy Voxtral-Mini-3B using Inferless

Voxtral-Mini-3B is Mistral AI's open-source, 3-billion-parameter multimodal speech model that delivers high-quality audio transcription, speech understanding, and conversational capabilities across multiple languages.

## TL;DR:
- Deployment of Voxtral-Mini-3B model using [transformers](https://pypi.org/project/transformers/).
      ...
      "inputs": [
                  {
                        "name": "audio_path",
                        "shape": [1],
                        "data": ["https://huggingface.co/datasets/hf-internal-testing/dummy-audio-samples/resolve/main/mary_had_lamb.mp3"],
                        "datatype": "BYTES"},
                  {
                        "name": "text_prompt",
                        "shape": [1],
                        "data": ["What can you tell me about the audio?"],
                        "datatype": "BYTES"}
    ]
}'
```
